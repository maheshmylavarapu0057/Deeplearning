...
#            inputs, labels = inputs.cuda(), labels.cuda()
        optimizer.zero_grad()
        print(summary(resnext101_32x8d(pretrained=True),inputs,show_input=True))
#       
        #print(summary(_resnet('resnext101_32x8d', Bottleneck, [2, 3, 2, 2]),inputs,show_input=False))
#        print(summary(ResNet(BasicBlock,[18,18,18]),inputs, show_input=False))
