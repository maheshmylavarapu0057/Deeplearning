...
TEST_PREFIX = "/home2/mylavarapu.maheswara/data/CIFAR-100-C/" # The directory that saves the CIFAR-10-C / CIFAR-100-C (unzipped) dataset (${TEST_PREFIX}/labels.npy should exist)
